package com.hsdroid.moviebuff.ui.favourites;
...
import com.hsdroid.moviebuff.databinding.FragmentFavouritesBinding;
...
public class FavouritesFragment extends Fragment {
    ...
    private void callToFirebaseDb() {
        mFirebaseDatabase.child(userId).child("Favourites").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dsp : dataSnapshot.getChildren()) {
                    ...
                    Log.d("FETCH:::::::::::", String.valueOf(dsp.getValue()));
                }
                if (getActivity() != null) {
                    fetchData();
                }
        ...
        try {
            ...
            if (jsonArray != null && jsonArray.length() > 0) {
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    filterFavouritesList(favouritesList);
                }
            }
    ...
    private void filterFavouritesList(ArrayList<String> favouritesList) {
